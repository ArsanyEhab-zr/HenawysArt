...
const Policies = () => {
    ...
    return (
        <div className="pt-24 pb-12 min-h-screen bg-gray-50 dark:bg-[#0f172a] transition-colors duration-300">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    className="bg-white dark:bg-[#1e293b] rounded-2xl shadow-sm p-8 space-y-12 transition-colors duration-300 border border-gray-100 dark:border-gray-800"
                >
                    {/* ⚠️ التعديل المهم هنا:
          ...
          */}
                    ...
                    {/* 🚚 Shipping Policy */}
                    <section id="shipping" className="border-b border-gray-100 dark:border-gray-800 pb-8 scroll-mt-28">
                        <h2 className="text-2xl font-script font-bold text-primary dark:text-primary-light mb-4">Shipping Policy</h2>
                    ...
                    {/* 🔄 Returns & Refunds */}
                    <section id="returns" className="border-b border-gray-100 dark:border-gray-800 pb-8 scroll-mt-28">
                        <h2 className="text-2xl font-script font-bold text-primary dark:text-primary-light mb-4">Returns & Refunds</h2>
                        <div className="space-y-3 text-gray-600 dark:text-gray-400">
                    ...
                    {/* 🛡️ Privacy Policy */}
                    <section id="privacy" className="border-b border-gray-100 dark:border-gray-800 pb-8 scroll-mt-28">
                        <h2 className="text-2xl font-script font-bold text-primary dark:text-primary-light mb-4">Privacy Policy</h2>
                        <div className="space-y-3 text-gray-600 dark:text-gray-400">
                    ...
                    <section id="contact" className="scroll-mt-28">
                        <h2 className="text-2xl font-script font-bold text-primary dark:text-primary-light mb-4">Need Help?</h2>
