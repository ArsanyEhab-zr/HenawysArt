    ...
    <div className="min-h-screen bg-white dark:bg-[#0f172a] transition-colors duration-300">
      ...
      <section className="pt-32 pb-20 bg-background dark:bg-[#0f172a] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-script text-text dark:text-[#e2e8f0] mb-6">
              Behind the Art
            </h1>
            <p className="text-xl md:text-2xl text-text-light dark:text-[#94a3b8] max-w-3xl mx-auto leading-relaxed font-light">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mt-16">
            {stats.map((stat, index) => (
              <motion.div
                ...
                // 👇 الكروت بقت كحلي في الدارك
                className="bg-white dark:bg-[#1e293b] p-6 rounded-2xl shadow-sm border border-stone-100 dark:border-[#334155] flex items-center justify-center gap-4 hover:shadow-md transition-shadow"
              >
                <div className="p-3 bg-primary/10 rounded-full text-primary">
                  <stat.icon size={24} />
                </div>
                <div className="text-left">
                  <h3 className="text-2xl font-bold text-gray-800 dark:text-[#e2e8f0]">{stat.value}</h3>
                  <p className="text-sm text-gray-500 dark:text-[#94a3b8] uppercase tracking-wider">{stat.label}</p>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="relative bg-white dark:bg-[#1e293b] rounded-[3rem] p-8 shadow-xl border border-stone-100 dark:border-[#334155] overflow-hidden">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
                  ...
                  <div className="text-center opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
                    <div className="w-32 h-32 mx-auto bg-gray-200 dark:bg-gray-700 rounded-full flex items-center justify-center mb-3 border-2 border-dashed border-gray-400 overflow-hidden relative">
                      <img
                        src="/oldLogo.jpeg"
                        alt="Old Logo"
                    ...
                    <p className="text-sm text-gray-400 dark:text-gray-500">Where we started</p>
                  </div>
                  ...
                  <div className="text-center transform scale-110">
                    <div className="w-40 h-40 mx-auto bg-white dark:bg-[#0f172a] rounded-full flex items-center justify-center mb-3 shadow-lg border-4 border-primary/20 overflow-hidden">
                      <img
                        src="/logo.png"
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl font-script text-text dark:text-[#e2e8f0] mb-4">
                Growing with Art
              </h2>
              <div className="space-y-4 text-text-light dark:text-[#94a3b8] leading-relaxed text-lg">
                <p>
                  It all started on <span className="font-bold text-gray-800 dark:text-white">December 16, 2023</span>.
      ...
      <section className="py-20 bg-background dark:bg-[#0f172a]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-text-light dark:text-[#94a3b8] max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {values.map((value, index) => (
              <motion.div
                ...
                className="text-center p-8 rounded-3xl bg-white dark:bg-[#1e293b] shadow-[0_10px_40px_-10px_rgba(0,0,0,0.08)] border border-stone-50 dark:border-[#334155] hover:border-primary/20 transition-all duration-300"
              >
                ...
                <h3 className="text-2xl font-bold text-gray-800 dark:text-[#e2e8f0] mb-4">
                  {value.title}
                </h3>
      ...
      {/* 4. Workspace Section */}
      <section className="py-20 bg-[#fdfbf7] dark:bg-[#0f172a]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-text-light dark:text-[#94a3b8] leading-relaxed mb-8">
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-6">
                <div className="flex items-center gap-3 bg-white dark:bg-[#1e293b] px-5 py-3 rounded-full shadow-sm text-gray-700 dark:text-[#e2e8f0]">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="aspect-video rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white dark:border-[#1e293b] transform rotate-2 hover:rotate-0 transition-transform duration-500">
                <img
